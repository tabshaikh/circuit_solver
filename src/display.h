...
class display
{
    public:
        ...
        void ac_source(float rotateangle,float translatex,float translatey,string type,string name,float dcoffset,float amplitude,float frequency,float delay,float df,string fname,string unit,bool posdirection);
        void ac_current(float rotateangle,float translatex,float translatey,string type,string name,float dcoffset,float amplitude,float frequency,float delay,float df,string fname,string unit,bool posdirection);  
